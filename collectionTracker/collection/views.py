...
def get_user_album_ids(user):
    ...
    return user_album_ids, user_wishlist_ids, user_collection, user_wishlist
...
def album_overview(request):
    user_album_ids, user_wishlist_ids, user_collection, user_wishlist = get_user_album_ids(request.user)
